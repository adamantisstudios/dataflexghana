...
import { calculateExactCommission, getDisplayCommission } from "./commission-calculator"
...
export async function syncDataOrderCommission(
  ...
  try {
    ...
    const exactCommission = calculateExactCommission(bundle.price, bundle.commission_rate)
    const displayCommission = getDisplayCommission(bundle.price, bundle.commission_rate)
