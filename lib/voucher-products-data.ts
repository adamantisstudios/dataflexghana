// Hard-coded educational products data
...
export const VOUCHER_PRODUCTS: EProduct[] = [
  ...
  {
    id: 2,
    title: "Kumasi Technical University Post Graduate Admission Voucher",
    description:
  ...
  {
    id: 3,
    title: "Accra Technical University – ATU Voucher",
    description:
  ...
  {
    id: 4,
    title: "Cape Coast Technical University Admission Voucher for Masters",
    description:
  ...
  {
    id: 5,
    title: "University of Cape Coast Post Graduate Forms",
    description:
  ...
  {
    id: 6,
    title: "Sunyani Technical University Post Graduate Admission Voucher",
    description:
  ...
  {
    id: 7,
    title: "CTVET Results Checker Card",
    description:
  ...
  {
    id: 8,
    title: "University for Development Studies Admission Form",
    description:
  ...
  {
    id: 9,
    title: "Buy GBCE Results Checker Card – WAEC PINs",
    description:
  ...
  {
    id: 10,
    title: "Kumasi Technical University Admission Undergraduate Forms",
    description:
  ...
  {
    id: 11,
    title: "WASSCE Results Checker Card – PIN",
    description:
  ...
  {
    id: 12,
    title: "University of Cape Coast Undergraduate Forms",
    description:
  ...
  {
    id: 13,
    title: "Kwame Nkrumah University of Science and Technology – KNUST Voucher",
    description:
  ...
  {
    id: 14,
    title: "College of Education Voucher",
    description:
  ...
  {
    id: 16,
    title: "Ho Technical University Post Graduate Admission Voucher",
    description:
  ...
  {
    id: 17,
    title: "Cape Coast Technical University Undergraduate Admission Voucher",
    description:
  ...
  {
    id: 19,
    title: "Ho Technical University Undergraduate Admission Voucher",
    description:
  ...
  {
    id: 20,
    title: "University of Education, Winneba Admission Voucher",
    description:
  ...
  {
    id: 21,
    title: "Sunyani Technical University Undergraduate Admission Voucher",
    description:
...
export function categorizeProduct(title: string): string {
  ...
  if (
    lowerTitle.includes("bece") ||
    lowerTitle.includes("wassce") ||
    lowerTitle.includes("abce") ||
    lowerTitle.includes("gbce") ||
    lowerTitle.includes("nvti") ||
    lowerTitle.includes("ctvet") ||
    lowerTitle.includes("results checker")
  ) {
