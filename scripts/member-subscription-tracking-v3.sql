-- ============================================================
-- MEMBER SUBSCRIPTION TRACKING - FIX v3
-- Combined table creation + fixed RLS policies
-- ============================================================
...
-- Fixed RLS policies with proper type handling - agent_id is UUID in this table, not text
