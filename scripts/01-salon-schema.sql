...
-- Fixed: no duplicate policy errors, conditional creation for everything
...
-- =====================================================
-- 2. Insert categories (ON CONFLICT DO NOTHING)
-- =====================================================
...
-- =====================================================
-- 3. Insert Accra locations (ON CONFLICT DO NOTHING)
-- =====================================================
...
-- =====================================================
-- 5. Insert sample services (ON CONFLICT)
-- =====================================================
...
ALTER TABLE salon_referrals ENABLE ROW LEVEL SECURITY;

-- =====================================================
-- 7. Drop existing policies (to avoid duplicate errors)
--    Then recreate them
-- =====================================================

DROP POLICY IF EXISTS "Allow public read access to services" ON salon_services;
DROP POLICY IF EXISTS "Allow public read access to categories" ON salon_categories;
DROP POLICY IF EXISTS "Allow public read access to locations" ON salon_locations;
DROP POLICY IF EXISTS "Allow public create bookings" ON salon_bookings;
DROP POLICY IF EXISTS "Allow public read bookings" ON salon_bookings;
DROP POLICY IF EXISTS "Allow public insert referrals" ON salon_referrals;
DROP POLICY IF EXISTS "Allow public read referrals" ON salon_referrals;
...
CREATE POLICY "Allow public insert referrals" ON salon_referrals
  FOR INSERT WITH CHECK (true);

CREATE POLICY "Allow public read referrals" ON salon_referrals
  FOR SELECT USING (true);

-- =====================================================
-- Done - Salon schema is ready
-- =====================================================
