      ...
      <div className="min-h-screen flex flex-col bg-gray-50">
          ...
          <div className="max-w-4xl mx-auto w-full px-4 py-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl md:text-2xl font-bold text-gray-900">Candidate Search</h1>
                  <p className="text-gray-600 text-sm">Find qualified professionals</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-8 md:py-12">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-8 mb-8 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">Find Top Talent in Ghana</h2>
            ...
            <div className="flex flex-col gap-4">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-12 text-base border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-full py-3"
                />
              </div>
              ...
              <div className="text-sm text-gray-500">
                <span className="text-green-600 font-medium">{getRemainingSearches()} free searches</span> available
                today
              </div>
            </div>
          </div>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Ready to Find Great Talent?</h3>
    ...
    return (
      <div className="min-h-screen flex flex-col bg-gray-50">
        <header className="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
          <div className="max-w-4xl mx-auto w-full px-4 py-4">
            <div className="flex items-center gap-3">
              <Button variant="outline" size="sm" asChild className="border-gray-300 hover:bg-gray-100 bg-transparent">
                <Link href="/">
                  <Home className="h-4 w-4" />
                  <span className="hidden sm:inline ml-2">Home</span>
                </Link>
        ...
        <div className="max-w-4xl mx-auto w-full px-4 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl md:text-2xl font-bold text-gray-900">Search Results</h1>
          ...
          <div className="flex gap-3">
            <div className="relative flex-1">
              ...
              <Input
                ...
                onChange={(e) => setSearchTerm(e.target.value)}
                onKeyPress={handleKeyPress}
                className="pl-10 text-sm border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-full py-2"
              />
            </div>
            <Button
              onClick={handleSearch}
