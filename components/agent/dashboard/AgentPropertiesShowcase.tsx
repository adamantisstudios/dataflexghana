  ...
  return (
    <div className="mb-8">
      <div className="text-center mb-6">
        <Badge className="bg-emerald-100 text-emerald-800 border-emerald-200 mb-3">💰 Earn Commission</Badge>
            ...
            <div>
              <CardHeader className="p-0 mb-4">
                <div className="flex items-start justify-between mb-2">
                  <CardTitle className="text-xl text-emerald-800">{latestProperty.title}</CardTitle>
                </div>
      ...
      <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl shadow-lg border border-emerald-200 p-6">
        <div className="text-center mb-4">
          <h3 className="text-xl font-bold text-emerald-800 mb-2">🚀 Become a Top Real Estate Agent!</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div className="bg-white/80 rounded-lg p-4 border border-emerald-200 text-center">
            <TrendingUp className="h-8 w-8 mx-auto mb-2 text-emerald-600" />
            <h4 className="font-semibold text-emerald-800">Earn More</h4>
            <p className="text-sm text-emerald-600">Commission on every property promotion</p>
          </div>
          <div className="bg-white/80 rounded-lg p-4 border border-emerald-200 text-center">
            <Users className="h-8 w-8 mx-auto mb-2 text-emerald-600" />
            <h4 className="font-semibold text-emerald-800">Help Others</h4>
            <p className="text-sm text-emerald-600">Connect buyers with perfect properties</p>
          </div>
          <div className="bg-white/80 rounded-lg p-4 border border-emerald-200 text-center">
            <DollarSign className="h-8 w-8 mx-auto mb-2 text-emerald-600" />
            <h4 className="font-semibold text-emerald-800">Build Wealth</h4>
            <p className="text-sm text-emerald-600">Grow your real estate business</p>
          </div>
        </div>
