  ...
  return (
    <div className="relative mb-8">
          ...
          >
            <div className="flex items-start justify-between">
              <div className="text-white flex-1">
                ...
                <button className="bg-white bg-opacity-20 hover:bg-opacity-30 transition-all duration-200 border-none px-4 py-2 rounded-lg text-sm font-semibold text-white">
                  {card.buttonText}
                </button>
              </div>
      ...
      <div className="lg:hidden relative">
        {/* Scroll Buttons - FIXED: Repositioned and made smaller */}
        {canScrollLeft && (
          <Button
            variant="outline"
            size="icon"
        ...
        {/* Scrollable Container - FIXED: Added padding to prevent button overlap */}
        <div
          ...
          {menuCards.map((card) => (
            ...
            >
              <div className="text-white flex-1 max-w-[60%] pr-2">
                ...
                <button className="bg-white bg-opacity-20 hover:bg-opacity-30 transition-all duration-200 border-none px-3 py-2 rounded-lg text-xs font-semibold text-white">
                  {card.buttonText}
                </button>
              </div>
