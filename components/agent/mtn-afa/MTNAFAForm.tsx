...
export default function MTNAFAForm() {
  ...
  if (showSuccess) {
  return (
    <div className="bg-emerald-50 min-h-screen flex items-center justify-center p-3">
      <Card className="w-full max-w-sm sm:max-w-md border-emerald-200 shadow-lg">
        <CardHeader className="bg-gradient-to-r from-emerald-600 to-green-600 text-white p-4 sm:p-5">
          <div className="flex items-center gap-2 sm:gap-3">
            <CheckCircle className="h-5 w-5 sm:h-6 sm:w-6 flex-shrink-0" />
            <div>
              <CardTitle className="text-sm sm:text-base">Registration Submitted Successfully</CardTitle>
        ...
        <CardContent className="p-4 sm:p-5 space-y-3 sm:space-y-4">
          ...
          <div className="space-y-1">
            <p className="text-xs sm:text-sm text-gray-600 font-medium">Submission ID</p>
            <div className="flex gap-2 items-center">
              <code className="flex-1 bg-gray-100 p-2 sm:p-3 rounded border text-center font-mono text-xs sm:text-sm text-emerald-700 break-all">
                {submissionId}
              </code>
              <CopyButton value={submissionId} label="Copy" size="xs" className="h-7 sm:h-8" />
            </div>
          </div>

          {/* Payment PIN */}
          <div className="bg-amber-50 border border-amber-300 rounded-lg p-3 sm:p-4 space-y-2">
            <p className="text-xs sm:text-sm font-semibold text-amber-800">Payment PIN</p>
            <div className="flex gap-2 items-center bg-white p-2 sm:p-3 rounded border border-amber-400">
              <code className="flex-1 font-mono font-bold text-lg sm:text-2xl text-amber-900 text-center">
                {paymentPin}
              </code>
              <CopyButton value={paymentPin} label="Copy" size="xs" className="h-7 sm:h-8 flex-shrink-0" />
            </div>
            <p className="text-[10px] sm:text-xs text-amber-700">
              Use this PIN when making payment to verify your submission
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4">
            <div className="flex gap-2 sm:gap-3">
              ...
              <div className="text-xs sm:text-sm">
                ...
                <p className="text-blue-800 leading-relaxed">{PAYMENT_INSTRUCTION}</p>
                <div className="flex gap-2 items-center mt-2 sm:mt-3 bg-white p-2 sm:p-3 rounded border border-blue-300">
          ...
          <Button
            ...
            className="w-full bg-emerald-600 hover:bg-emerald-700 text-sm sm:text-base py-2 sm:py-2.5"
          >
            Back to Dashboard
          </Button>
        </CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <Input
                ...
                className="mt-2 border-emerald-200 focus:border-emerald-500"
              />
              <p className="text-xs text-gray-500 mt-1">Format: DD/MM/YYYY (e.g., 15/05/1990)</p>
            </div>
            {/* Location */}
            <div>
          ...
          <AlertDialogContent className="w-[95vw] max-w-md">
            ...
            <div className="space-y-3 bg-emerald-50 rounded-lg p-4 border border-emerald-200">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-semibold text-emerald-900">{formData.date_of_birth}</span>
              </div>
              <div className="flex justify-between text-sm">
