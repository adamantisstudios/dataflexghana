...
export function BankAccountForm({ agentId, onComplete, onCancel }: BankAccountFormProps) {
  ...
  const handleGhanaCardChange = (file: File | null, side: "front" | "back" = "front") => {
    if (!file) return
  ...
  const removeGhanaCard = (side: "front" | "back" | "all" = "all") => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Upload Ghana card front if provided
      if (ghanaCardFile) {
      ...
      // Upload Ghana card back if provided
          ...
          {currentStep === 8 && (
            <div className="space-y-6 w-full">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-xs font-medium">Ghana Card - Front *</Label>
                    <div className="border-2 border-dashed border-blue-300 rounded-lg p-3 w-full mt-1">
                      {ghanaCardPreview ? (
                        ...
                        <label className="flex flex-col items-center cursor-pointer py-6 w-full">
                          ...
                          <input
                            ...
                            accept="image/*"
                            className="hidden"
                            onChange={(e) => handleGhanaCardChange(e.target.files?.[0] || null, "front")}
                          />
                        </label>
                      )}
                    </div>
                  ...
                  <div>
                    <Label className="text-xs font-medium">Ghana Card - Back *</Label>
                    <div className="border-2 border-dashed border-blue-300 rounded-lg p-3 w-full mt-1">
                      {ghanaCardBackPreview ? (
                        ...
                        <label className="flex flex-col items-center cursor-pointer py-6 w-full">
                          ...
                          <input
                            ...
                            accept="image/*"
                            className="hidden"
                            onChange={(e) => handleGhanaCardChange(e.target.files?.[0] || null, "back")}
                          />
                        </label>
                      )}
                    </div>
