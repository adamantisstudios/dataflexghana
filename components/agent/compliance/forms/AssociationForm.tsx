...
export function AssociationForm({ agentId, onComplete, onCancel }: AssociationFormProps) {
  ...
  const [ghanaCards, setGhanaCards] = useState({
    founder1_front: null as File | null,
    founder1_back: null as File | null,
    founder2_front: null as File | null,
    founder2_back: null as File | null,
    founder3_front: null as File | null,
    founder3_back: null as File | null,
    chairperson_front: null as File | null,
    chairperson_back: null as File | null,
    secretary_front: null as File | null,
    secretary_back: null as File | null,
  })
