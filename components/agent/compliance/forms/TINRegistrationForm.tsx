          ...
          <div className="space-y-4">
              ...
              <div className="border-2 border-dashed border-emerald-300 rounded-lg p-4">
                {signaturePreview ? (
                  <div className="relative">
                    <img src={signaturePreview || "/placeholder.svg"} alt="Signature" className="max-h-40 mx-auto" />
                    <Button
                      type="button"
                      variant="destructive"
                      size="sm"
            ...
            <div className="space-y-2">
              ...
              <div className="border-2 border-dashed border-emerald-300 rounded-lg p-4">
                {ghanaCardPreview ? (
                  <div className="relative">
                    <img src={ghanaCardPreview || "/placeholder.svg"} alt="Ghana Card" className="max-h-40 mx-auto" />
                    <Button
                      type="button"
                      variant="destructive"
                      size="sm"
