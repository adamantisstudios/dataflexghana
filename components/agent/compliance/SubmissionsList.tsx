...
export function SubmissionsList({
  ...
  return (
    <>
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                  ...
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-semibold text-gray-900 break-words text-base">{formName}</h4>
                  ...
                  {/* Status badge */}
                  <Badge className={`${getStatusColor(submission.status)} border-0 px-3 py-1 text-xs font-medium self-start`}>
                    {submission.status}
                  </Badge>
                </div>
      ...
      {/* View Details Dialog – Mobile Optimized */}
        ...
        <DialogContent className="max-w-[95vw] sm:max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          {selectedSubmission && (
            <div className="space-y-4 mt-2">
              ...
              <div>
                <span className="font-semibold text-sm sm:text-base">Form Information</span>
                {/* Form fields – stacked on mobile, two columns on sm and up */}
              ...
              {selectedSubmission.form_data?.images && selectedSubmission.form_data.images.length > 0 && (
                <div className="pt-2">
                  <Button
                    variant="outline"
                    size="sm"
                  ...
                  >
                    ...
                    Download All Images ({selectedSubmission.form_data.images.length})
                  </Button>
                </div>
              )}
            </div>
