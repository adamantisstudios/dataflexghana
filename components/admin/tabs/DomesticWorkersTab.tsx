...
export default function DomesticWorkersTab() {
              ...
              <Card key={worker.id} className="border-green-200 hover:shadow-lg transition-shadow">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <Button size="sm" variant="outline" onClick={() => handleTogglePublish(worker)} className="text-xs">
                      {worker.is_published ? <EyeOff className="h-3 w-3 mr-1" /> : <Eye className="h-3 w-3 mr-1" />}
                      {worker.is_published ? "Unpublish" : "Publish"}
                    </Button>
                    <Button size="sm" variant="outline" onClick={() => copyWorkerDetails(worker)} className="text-xs">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Are you sure you want to delete {getAbridgedName(worker.full_name)}? This action cannot be
                          undone.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
        ...
        <Dialog open={showRequestModal} onOpenChange={setShowRequestModal}>
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4">
              ...
              {selectedRequest.additional_info && (
                <div>
                  ...
                  <p className="mt-1 text-sm text-blue-600">{selectedRequest.additional_info}</p>
                </div>
              )}
            ...
            <div className="flex gap-4 pt-4 border-t border-blue-200">
              ...
              <Button variant="destructive" onClick={() => handleDeleteRequest(selectedRequest.id)} className="flex-1">
                Delete
              </Button>
