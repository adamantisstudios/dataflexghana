                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs sm:text-sm">
                    {Object.entries(selectedSubmission.form_data).map(([key, value]) => (
                      <div key={key} className="break-words">
                        ...
                        <p className="text-emerald-600 mt-1">{String(value)}</p>
                      </div>
                    ))}
                  </div>
                )}
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent className="max-w-[95vw] sm:max-w-lg">
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Are you sure you want to delete this submission? This action cannot be undone and will delete
                        all associated images and chat messages.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
