...
export default function WalletsTab({ getCachedData, setCachedData }: WalletsTabProps) {
  ...
  const updateWalletTransactionStatus = async (transactionId: string, newStatus: string) => {
    try {
