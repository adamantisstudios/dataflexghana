...
const networks = {
  mtn: {
    ...
    plans: [
      ...
      { size: "20GB", price: 90.0 },
      { size: "25GB", price: 111.0 },
      { size: "30GB", price: 132.0 },
      { size: "40GB", price: 169.0 },
      { size: "50GB", price: 207.0 },
      { size: "100GB", price: 403.0 },
    ],
  },
  telecel: {
    name: "Telecel",
    ...
    plans: [
      { size: "5GB", price: 33.0 },
      { size: "10GB", price: 52.0 },
      { size: "15GB", price: 74.0 },
      { size: "20GB", price: 94.0 },
      { size: "25GB", price: 116.0 },
      { size: "30GB", price: 132.0 },
      { size: "40GB", price: 175.0 },
      { size: "50GB", price: 214.0 },
      { size: "100GB", price: 420.0 },
    ],
  },
  airteltigo: {
    name: "AirtelTigo",
    ...
    plans: [
      ...
      { size: "15GB", price: 63.0 },
      { size: "20GB", price: 70.0 },
      { size: "25GB", price: 87.0 },
      { size: "30GB", price: 95.0 },
      { size: "40GB", price: 112.0 },
      { size: "50GB", price: 120.0 },
      { size: "60GB", price: 132.0 },
      { size: "80GB", price: 161.0 },
      { size: "100GB", price: 223.0 },
    ],
  },
}
