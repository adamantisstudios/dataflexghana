            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <Card className="border-2 border-green-200 shadow-xl bg-gradient-to-br from-green-50 to-emerald-50 backdrop-blur-sm">
                <CardContent className="p-4 sm:p-6 lg:p-8 text-center">
                  <div className="space-y-4">
                    <div>
                      <p className="text-gray-600 text-sm font-medium mb-2">One-Time Registration Fee:</p>
                      <div className="bg-gradient-to-r from-emerald-500 to-green-500 rounded-xl px-4 py-4 mb-4">
                        <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-1">₵47</div>
                        <div className="text-emerald-100 text-sm sm:text-base font-semibold">
                          Your lifetime access to 50+ earning services
                        </div>
                      </div>
                    </div>

                    {/* Automatic Wallet Credit Section */}
                    <div className="border-t-2 border-green-200 pt-4">
                      <p className="text-gray-700 text-sm font-semibold mb-3">✨ AFTER ADMIN APPROVAL:</p>
                      <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-xl px-4 py-3 shadow-md">
                        <div className="text-3xl sm:text-4xl font-bold text-yellow-900 mb-1">+ ₵5</div>
                        <div className="text-yellow-900 text-sm sm:text-base font-semibold">
                          Automatically credited to your wallet
                        </div>
                      </div>
                      <p className="text-xs sm:text-sm text-gray-600 mt-3 leading-relaxed">
                        Your admin approval typically takes 24-48 hours. Once approved, ₵5 is instantly added to your
                        wallet so you can buy data bundles and test the system immediately!
                      </p>
                    </div>

                    <div className="border-t-2 border-green-200 pt-4">
                      <p className="text-sm sm:text-base text-green-700 font-semibold">
                        💡 Think of it like a movie ticket - once you pay for entry, you have full access to all the
              ...
              <Card className="border-2 border-blue-200 shadow-xl bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="space-y-3 sm:space-y-4 px-3 sm:px-6">
                  ...
                  {/* New Section: What Happens After Payment */}
                  <div className="bg-green-50 border border-green-200 rounded-lg p-3 sm:p-4 space-y-2">
                    ...
                    <ul className="text-xs sm:text-sm text-green-800 space-y-1">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Your account enters "Pending Approval" status</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 flex-shrink-0 mt-0.5 text-green-600" />
                        <span>Admin reviews and approves (typically 24-48 hours)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 flex-shrink-0 mt-0.5 text-green-600" />
                        <span>Upon approval, ₵5 automatically credited to your wallet</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 flex-shrink-0 mt-0.5 text-green-600" />
                        <span>Start buying data bundles and using the platform immediately!</span>
                      </li>
                    </ul>
                  </div>
              ...
              <Card className="border-2 border-purple-200 shadow-xl bg-white/80 backdrop-blur-sm">
                <CardHeader className="pb-3 sm:pb-4">
                  <CardTitle className="flex items-center gap-2 text-purple-800 text-base sm:text-lg">
                    ...
                    What You Get After Payment & Approval
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3 sm:space-y-4 px-3 sm:px-6">
                  {/* Automatic Wallet Credit Highlight */}
                  <div className="bg-yellow-50 border-l-4 border-yellow-500 rounded-lg p-3 sm:p-4 mb-3">
                    <p className="text-xs sm:text-sm font-semibold text-yellow-900 mb-1">🎁 Instant Welcome Bonus:</p>
                    <p className="text-sm sm:text-base font-bold text-yellow-800">
                      ₵5 automatically credited to your wallet upon approval!
                    </p>
                    <p className="text-xs text-yellow-700 mt-1">
                      Use it immediately to buy data, test the system, and start earning
                    </p>
                  </div>
              ...
              <Card className="border-2 border-orange-200 shadow-xl bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="space-y-3 sm:space-y-4 px-3 sm:px-6">
                  <div className="space-y-2 sm:space-y-3">
                    {[
                      "Send ₵47 to 0557943392 via Mobile Money",
