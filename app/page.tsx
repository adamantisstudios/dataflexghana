  ...
  const features = [
    {
      ...
      description:
        "Access reliable connectivity solutions across Ghana with MTN, AirtelTigo, and Telecel networks, providing you with multiple service options and competitive rates.",
    },
    {
      icon: <Banknote className="h-8 w-8 text-emerald-600" />,
      title: "Cost-Effective Solutions",
      description:
        "Get access to affordable, high-quality services with our competitive pricing and special offers designed to maximize your value and savings.",
    },
    {
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              Dataflex Ghana — All The Data (Info) You Need to Start <span className="text-emerald-600">Earning Online</span>
            </h2>
