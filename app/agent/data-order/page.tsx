...
export default function DataOrderPage() {
  ...
  // CRITICAL FIX: Add state for clean success notification
    ...
    try {
      ...
      if (paymentMethod === "wallet") {
        ...
        if (approvedWalletBalance < selectedBundle.price) {
          throw new Error("Insufficient approved wallet balance. Please ensure your wallet top-up has been approved by admin.")
        }
                  ...
                  <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-blue-700">
                        Send GH₵ {selectedBundle.price.toFixed(2)} to <strong>0557943392</strong> (Adamantis Solutions). Pay Before Order
                      </p>
                      <p className="text-sm text-blue-700">
                ...
                {successNotificationData.reference && (
                  <div className="bg-amber-50 rounded-lg p-3 border border-amber-200">
                    ...
                    <p className="text-amber-700 text-sm mb-2">
                      Send <strong>GH₵ {successNotificationData.amount.toFixed(2)}</strong> to <strong>0557943392</strong>
                    </p>
