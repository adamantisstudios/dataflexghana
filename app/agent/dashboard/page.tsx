...
import { VoucherCardsTab } from "@/components/agent/voucher/VoucherCardsTab"
...
export default function AgentDashboard() {
  ...
  const [activeTab, setActiveTab] = useState("voucher-cards")
      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
          <TabsContent value="voucher-cards" className="space-y-4">
            <VoucherCardsTab agentId={agent?.id || ""} agentName={agent?.full_name || ""} />
          </TabsContent>
