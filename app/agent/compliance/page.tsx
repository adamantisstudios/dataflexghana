        ...
        <DialogContent className="max-w-md">
          ...
          {selectedFormForInfo && (
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-lg mb-4">{selectedFormForInfo.name}</h3>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{selectedFormForInfo.duration}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{selectedFormForInfo.cost}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{selectedFormForInfo.delivery}</p>
                  </div>
                </div>
              </div>
