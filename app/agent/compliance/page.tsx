        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          ...
          <Card className="bg-gradient-to-br from-indigo-50 to-indigo-100 border-indigo-200">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-indigo-700">Delivered</p>
                  <p className="text-2xl font-bold text-indigo-900">{stats.delivered}</p>
                </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            <div className="space-y-4">
              <div>
                <CardTitle className="text-xl sm:text-2xl">Compliance Management</CardTitle>
                <CardDescription className="mt-2">Submit and track your compliance forms</CardDescription>
              </div>
              <Button
                  ...
                  >
                    <CardContent className="p-6 text-center">
                      <div className="mx-auto mb-4">
                        <Icon className={`h-12 w-12 ${form.iconColor}`} />
                      </div>
                      <h3 className="font-bold text-lg mb-2">{form.name}</h3>
                      <p className="text-sm text-gray-600 mb-4">{form.description}</p>
                      <Badge variant="secondary">Click to Start</Badge>
                    </CardContent>
                  </Card>
                )
              })}
