...
import { filterByAdvancedSearch } from "@/lib/advanced-search-matcher"
...
export async function GET(request: Request) {
  try {
    ...
    if (searchQuery) {
      ...
      filteredData = filterByAdvancedSearch(filteredData, searchQuery)

      console.log("[v0] Found", filteredData.length, "matching candidates using advanced search")
    }
