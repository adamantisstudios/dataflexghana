      ...
      <section id="agent-registration">
        ...
        <div className="bg-amber-50 dark:bg-amber-900/20 p-6 rounded-lg border-l-4 border-amber-500">
          ...
          <div className="space-y-4">
            ...
            <div>
              <h4 className="font-semibold text-amber-900 mb-2">Our Vision</h4>
              <p className="text-sm">
                We partnered with dozens of businesses nationwide, offering 50+ services. DataFlex is a full business
                ecosystem. We welcome serious, committed individuals only. If you want instant data, buy directly from
