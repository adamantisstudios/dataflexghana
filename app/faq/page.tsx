...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "24/7 support available via: WhatsApp (+233246827049), Phone (+233246827049), Email (support@dataflexghana.com). We respond to WhatsApp within 5 minutes during business hours. Our support team can help with technical issues, payment problems, or service questions.",
  },
  {
    id: "support-2",
    category: "Support & Help",
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">
                      <strong>WhatsApp:</strong> +233246827049
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
